...
import { AlertTriangle, AlertCircle, Bell, Activity } from 'lucide-react';
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Monitor critical medicine shortages across your network
          </p>
        </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-chart-4">--</p>
                </div>
              </div>
            </CardContent>
          </Card>
                ...
                <TableRow>
                  <TableCell colSpan={5} className="text-center py-12">
                    <div className="flex flex-col items-center gap-2 text-muted-foreground">
                      ...
                      <p className="text-sm">Select a hospital to view low stock alerts</p>
